...
const menuItems = menues.map((menues) => (
    ...
    <li className = "listItem">
    <p className = "item">
    <b> Name: </b>&nbsp;{menues.restaurantName} &nbsp;
    <b> Phone: </b>&nbsp;{menues.restaurantPhone} &nbsp;
    <b> Contact: </b> &nbsp; {menues.restaurantContact} &nbsp;
    <b> User Name: </b> &nbsp; {menues.restaurantUserName} &nbsp;
    <b> Password: </b> &nbsp; {menues.restaurantPassword} &nbsp;
    <b> Prize: </b> &nbsp; {menues.menuPrize} &nbsp;
    
    
    <button className = "itemButton" onClick={() => bn_AdminService.deleteMenues((menues._id).toString())}>Delete</button>
    </p>
    </li>
    </div>));
