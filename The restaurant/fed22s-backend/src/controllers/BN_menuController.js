...
const Order = require("../models/BN_Ordert");
...
exports.getAllMenues = async (req, res) => {
  try {
    ...
    console.log(menu);
    if (!menu) throw new NotFoundError("No menu item exist!");
...
exports.getMenuById = async (req, res) => {
  try {
    ...
    const menu = await Order.findById(menuId);
...
exports.updateMenuById = async (req, res) => {
  try {
    ...
    const menuId = req.params.cleanerId;
...
exports.deleteMenuById = async (req, res) => {
  try {
    const menuId = req.params.menuId;
    const menuToDelete = await Order.findById(menuId);
